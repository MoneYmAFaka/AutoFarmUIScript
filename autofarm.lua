...
print("ScreenGui created")-- Create Main Frame (the window)
...
print("Main Frame created")-- Add UICorner for rounded edges
local uiCorner = Instance.new("UICorner")
uiCorner.CornerRadius = UDim.new(0, 10)
uiCorner.Parent = mainFrame-- Add UIStroke for a border
local uiStroke = Instance.new("UIStroke")
uiStroke.Color = Color3.fromRGB(100, 100, 100)
uiStroke.Thickness = 2
uiStroke.Parent = mainFrame-- Make the frame draggable
local dragging = false
local dragInput
local dragStart
local startPosmainFrame.InputBegan:Connect(function(input)
...
end)mainFrame.InputChanged:Connect(function(input)
...
print("Title Bar created")local titleLabel = Instance.new("TextLabel")
...
print("Title Label created")-- Create Close Button
...
print("Close Button created")local closeCorner = Instance.new("UICorner")
closeCorner.CornerRadius = UDim.new(0, 5)
closeCorner.Parent = closeButtoncloseButton.MouseButton1Click:Connect(function()
    screenGui:Destroy()
end)-- Create Tab System
...
print("Tab Frame created")-- Main Tab Button
...
print("Main Tab Button created")-- Upgrades Tab Button
...
print("Upgrades Tab Button created")-- Create Tab Content Frames
...
print("Main Tab Content created")local upgradesTabContent = Instance.new("Frame")
...
print("Upgrades Tab Content created")-- Tab Switching Logic
mainTabButton.MouseButton1Click:Connect(function()
    mainTabContent.Visible = true
    upgradesTabContent.Visible = false
    mainTabButton.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
    upgradesTabButton.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
end)upgradesTabButton.MouseButton1Click:Connect(function()
...
local autoClick, autoAscend, autoRebirth, autoUpgrade = false, false, false, false-- Function to Create a Toggle
...
end-- Create Toggles in Main Tab
...
end)createToggle(mainTabContent, "Auto Ascend", UDim2.new(0, 10, 0, 60), function(state)
    autoAscend = state
    if autoAscend then
        spawn(function()
...
end)createToggle(mainTabContent, "Auto Rebirth", UDim2.new(0, 10, 0, 110), function(state)
    autoRebirth = state
    if autoRebirth then
        spawn(function()
...
end)-- Create Toggle in Upgrades Tab
...
end)print("Custom UI Script Loaded Successfully")
